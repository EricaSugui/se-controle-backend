...
import acertoContasRouter from './routes/acertoContas';
...
import despesasFixasRouter from './routes/despesasFixas';
import receitasFixasRouter from './routes/receitasFixas';
import saldoProjetadoRouter from './routes/saldoProjetado';
...
app.use('/casas/:casaId/acerto', acertoContasRouter);
...
app.use('/despesas-fixas', despesasFixasRouter);
app.use('/receitas-fixas', receitasFixasRouter);
app.use('/saldo-projetado', saldoProjetadoRouter);
